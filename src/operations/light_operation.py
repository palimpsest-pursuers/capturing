...
class ExposureWorker(QObject):
    ...
    def run(self):
        ...
        self.captureStatus.emit("Capturing Exposure levels at wavelength " + self.main.led_control.wavelength_list[self.waveIndex]
        ...
        self.main.camera_control.uninitialize_camera()
        self.finished.emit()
        self.captureStatus.emit("Select Exposure level for wavelength " + self.main.led_control.wavelength_list[self.waveIndex]
                                + " - (" + str(self.waveIndex + 1) + "/16)")
